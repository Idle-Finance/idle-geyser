...
import "./MasterChefTokenizerPolygon.sol";
 ...
 */
contract TokenGeyserPolygon is IStaking, Ownable {
    ...
    MasterChefTokenizerPolygon private _tokenizer;
    ...
    constructor(IERC20 stakingToken, IERC20 distributionToken, uint256 maxUnlockSchedules,
        ...
        _tokenizer = MasterChefTokenizerPolygon(address(stakingToken)); // staking token will be the tokenizer
